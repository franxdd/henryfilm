  ...
  return (
    <div className="cardCarrito">
      <div className="cardImg2">
        <img src={image} alt={nombre} height="120px" width="180px"   />
        {/* <img src={image} alt={nombre} height="130px" width="200px" /> */}
      </div>
      <div className="cardInfo2">
        <p className="textNameCarrito">Título: {nombre}</p>
        <p className="textDetalle"> Detalle: Es una {tipo}</p>
      </div>

       <div class="cardAbajo">
       <span className="textNameCarrito">${precio}</span>
