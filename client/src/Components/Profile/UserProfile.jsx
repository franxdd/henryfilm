  ...
  return (
    <div className="container3">
      <div className="profileTitle">
        <h3>
          <img className="logo" src={bienvenido} alt="Logo" height="auto" width="250px" />
        </h3>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="ContainerPerfil">
            ...
            {img === false ? (
              ...
              <div>
                {" "}
                <input id="avatar" type="file" name="avatar" onChange={(e) => HandleInputImg(e)} />
                <Button
                  onClick={(e) => handleEditimg(e)}
                  style={{
                    marginLeft: "-140px",
            ...
            <div className="namediv">
              {nombre === false ? (
                ...
                <div>
                  <input id="nickname" type="text" name="nickname" onChange={(e) => HandleInput(e)} />
                  <Button
                    onClick={(e) => handleEdit(e)}
                    style={{
                      marginLeft: "4px",
            ...
            <div className="boton">
              <button className="card-button" type="submit" style={{ marginTop: "-18%" }}>
                MODIFICAR
              </button>
            </div>
          </div>
